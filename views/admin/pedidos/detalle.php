<div class="pedidos">
    ...
    <div class="formulario__card m__bottom">
        ...
        <div class="detalle__pedido--info">
            <div>
                <span class="detalle__pedido--label">Cliente</span>
                <p><?php echo s($pedido['client_name'] ?? 'Sin cliente'); ?></p>
            </div>
        ...
        <div class="formulario__card m__bottom">
            ...
            <div class="excel__acciones">
                <a href="/admin/pedidos/listado" class="btn btn__transparente"><i class="fa-solid fa-arrow-left"></i>Volver al listado</a>
            </div>
        </div>
    </div>
</div>