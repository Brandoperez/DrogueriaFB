        ...
        <section class="formulario__card">
            <div class="formulario__campos">
                <div class="formulario__campo">
                    <label>Cliente:</label>
                    <input type="text" id="cliente" value="<?php echo s($cliente->name); ?>" readonly>
                    <input type="hidden" name="cliente_id" id="cliente_id" value="<?php echo s($cliente->id); ?>">
...
<script>
    window.clienteActual = {
        ...
        price_list_id: <?php echo (int) ($cliente->price_list_id ?? 0); ?>
    };
    window.RUTA_BUSCAR_PRODUCTOS = '/api/cliente/pedidos/productos';
</script>
